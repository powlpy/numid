...
mod tests {
    ...
    fn test_const_create_lower() {
        ...
        const _: IdWithInitVal = IdWithInitVal::const_create_lower(50);
        const _: IdWithInitVal = IdWithInitVal::const_create_lower(100);

        const _: UnusedId = UnusedId::const_create_lower(5);
    }
